...
echo "========================================"
echo " Creating venus Droidspaces config"
echo " Forcing EvolutionX vermagic localversion"
echo "========================================"
...
# Try to match EvolutionX original module vermagic:
# Original kernel release:
# 5.4.302-qgki-g7f2a2a060d1d
CONFIG_LOCALVERSION="-qgki-g7f2a2a060d1d"
